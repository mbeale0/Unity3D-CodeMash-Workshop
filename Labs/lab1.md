...
As you may have guessed, this function will run whenever an object enters the trigger. ([Function Docs](https://docs.unity3d.com/ScriptReference/Collider.OnTriggerEnter.html))
